...
namespace core {
    namespace util {
         ...
         * its name, this interface models the mathematical <i>setValue</i> abstraction.
         *
         ...
         * that all constructors must create a setValue that contains no duplicate elements
         * (as defined above).
         *
         * <p>Note: Great care must be exercised if mutable objects are used as setValue
         * elements.  The behavior of a setValue is not specified if the value of an object
         * is changed in a manner that affects <b> equals</b> comparisons while the
         * object is an element in the setValue.  A special case of this prohibition is
         * that it is not permissible for a setValue to contain itself as an element.
         *
         * <p>Some setValue implementations have restrictions on the elements that
         ...
         * the insertion of an ineligible element into the setValue may throw an
         ...
         * <li>The iteration order of setValue elements is unspecified and is subject to change.
        ...
        public:
            ...
            /**
             * Returns the number of elements in this setValue (its cardinality).  If this
             * setValue contains more than <b> Integer.MAX_VALUE</b> elements, returns
             ...
             *         is incompatible with this setValue (<a href="">optional</a>)
             */
            gbool contains(const E &o) const override {
                return Collection<E>::contains(o);
            }

            /**
             * Returns an iterator over the elements in this setValue.  The elements are
             * returned in no particular order (unless this setValue is an INSTANCE of some
             ...
             * <b> e</b> to this setValue if the set contains no element <b> e2</b>
             * such that
             ...
             * Individual setValue implementations should clearly document any
             ...
             *         is not supported by this setValue
             * @throws ClassCastException if the class of the specified element
             *         prevents it from being added to this setValue
             ...
             * this setValue contains such an element.  Returns <b> true</b> if this set
             * contained the element (or equivalently, if this setValue changed as a
             * result of the call).  (This setValue will not contain the element once the
             * call returns.)
             *
            ...
            gbool remove(const E &o) override {
                return Collection<E>::remove(o);
            }

            /**
             * Returns <b> true</b> if this setValue contains all of the elements of the
             * specified collection.  If the specified collection is also a setValue, this
             * method returns <b> true</b> if it is a <i>subset</i> of this setValue.
             *
             * @param  c collection to be checked for containment in this setValue
             *
             * @throws ClassCastException if the types of one or more elements
             *         in the specified collection are incompatible with this
             *         setValue (<a href="">optional</a>)
             * @see    contains(Object)
             */
            ...
            /**
             * Adds all of the elements in the specified collection to this setValue if
             * they're not already present (optional operation).  If the specified
             * collection is also a setValue, the <b> addAll</b> operation effectively
             * modifies this setValue so that its value is the <i>union</i> of the two
             ...
             *         specified collection prevents it from being added to this setValue
            ...
            /**
             * Removes from this setValue all of its elements that are contained in the
             * specified collection (optional operation).  If the specified
             * collection is also a setValue, this operation effectively modifies this
             * set so that its value is the <i>asymmetric setValue difference</i> of
             * the two sets.
             *
             * @param  c collection containing elements to be removed from this setValue
             * @return <b> true</b> if this setValue changed as a result of the call
             * @throws UnsupportedMethodException if the <b> removeAll</b> operation
             *         is not supported by this setValue
             * @throws ClassCastException if the class of an element of this setValue
            ...
            /**
             * Retains only the elements in this setValue that are contained in the
             * specified collection (optional operation).  In other words, removes
             * from this setValue all of its elements that are not contained in the
             * specified collection.  If the specified collection is also a setValue, this
             * operation effectively modifies this setValue so that its value is the
             * <i>intersection</i> of the two sets.
             *
             * @param  c collection containing elements to be retained in this setValue
             * @return <b> true</b> if this setValue changed as a result of the call
            ...
            /**
             * Removes all of the elements from this setValue (optional operation).
            ...
            /**
             * Compares the specified object with this setValue for equality.  Returns
             * <b> true</b> if the specified object is also a setValue, the two sets
             * have the same size, and every member of the specified setValue is
             * contained in this set (or equivalently, every member of this setValue is
             * contained in the specified setValue).  This definition ensures that the
             * equals method works properly across different implementations of the
             * setValue interface.
             *
             * @param o object to be compared for equality with this setValue
             * @return <b> true</b> if the specified object is equal to this setValue
             */
        ...
        private:
            ...
            template<class T = E, class U = E>
            class SetIterator CORE_FINAL : public Iterator<T> {
            private:
                Iterator<U> &it;

            public:
                CORE_EXPLICIT SetIterator(Iterator<U> &it) : it(it) {}
            ...
            template<class T = E>
            class BoundedIterator CORE_FINAL : public Iterator<T> {
            private:
                Array<E> &data;
                gint cursor = 0;
            ...
            template<class T = E>
            class ImmutableSet CORE_FINAL : public Set<T> {
            private:
                Array<E> data;
            ...
            public:
                ...
                void clear() override {
                    if (size() > 0) {
                        UnsupportedOperationException().throws(__trace(this->classname()));
                    }
                }
                ...
                Iterator<const E> &iterator() const override {
                    return Unsafe::allocateInstance<BoundedIterator<const E>>((Array<E> &) data);
                }
            ...
            template<class T = E>
            class UnmodifiableSet CORE_FINAL : public Set<T> {
            private:
                Set &This;
                gbool destroy;
            ...
            public:
                CORE_EXPLICIT UnmodifiableSet(Set &s, gbool destroy) : This(s), destroy(destroy) {}
                ...
                Iterator<const E> &iterator() const override {
                    return Unsafe::allocateInstance<SetIterator<const E>>(This.iterator());
                }

                Iterator<T> &iterator() override {
                    return Unsafe::allocateInstance<SetIterator<>>(This.iterator());
                }
            ...
            public:
                ...
                Object &clone() const override {
                    return Unsafe::allocateInstance<EmptyIterator>();
                }
                ...
                T &next() override {
                    NoSuchElementException().throws(__trace(this->classname()));
                }
                ...
                gbool equals(const Object &o) const override {
                    return this == &o || Class<EmptyIterator>::hasInstance(o);
                }
            };

            template<class T = E>
            class UnmodifiableEmptySet CORE_FINAL : public Set<T> {
            public:
                ...
                Iterator<const E> &iterator() const override {
                    return Unsafe::allocateInstance<EmptyIterator<const E>>();
                }
        ...
        public:
            /**
             * Return unmodifiable copy of given setValue
             */
            ...
            static Set &of() {
                static UnmodifiableEmptySet<E> EMPTY_SET = {};
                return EMPTY_SET;
            }
            ...
            static Set &of(const E &e0, const E &e1, const E &e2, const E &e3, const E &e4, const E &e5, const E &e6,
                ...
                return arrayToSet(Array<E>::of(e0, e1, e2, e3, e4, e5, e6, e7, e8, e9,
                                               Unsafe::forwardInstance<Others>(others)...));
            }
