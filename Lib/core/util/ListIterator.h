...
namespace core {
    namespace util {
         ...
         * cursor positions:  ^            ^            ^            ^                  ^
         * </PRE>
         * Note that the <b style="color:orange;">ListIterator.remove</b> and <b style="color:orange;">ListIterator.setValue(Object)</b> methods are
        ...
        template<class E>
        class ListIterator<const E> : public Iterator<const E> {
        protected:
            CORE_ALIAS(ActionConsumer, , function::Consumer<E>);
