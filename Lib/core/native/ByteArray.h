...
namespace core {
    namespace native {
         ...
         */
        class ByteArray CORE_FINAL : public PrimitiveArray<Byte> {
        private:
            CORE_ALIAS(Value, PrimitiveArray<Byte>::Value);
            // gbyte[*]
        ...
        public:
             ...
             *                      array creation.
             */
            CORE_EXPLICIT ByteArray(gint length, Value initialValue);
             ...
             */
            static ByteArray of(Value v0, Value v1);
             ...
             */
            static ByteArray of(Value v0, Value v1, Value v2);
             ...
             */
            static ByteArray of(Value v0, Value v1, Value v2, Value v3);
            ...
            static ByteArray of(Value v0, Value v1, Value v2, Value v3, Value v4, Value v5,
                                   Value v6, Value v7, Value v8, Value v9, Values &&...others) {
                CORE_STATIC_ASSERT(Class<ByteArray>::template allIsTrue<Class<Values>::template isConvertible<Value>()...>(),
                                   "Could not create array with given arguments");
                try {
                    CORE_FAST gint n = sizeof...(Values);
                    ByteArray array{10 + n};
