...
#ifndef CORE23_LONGARRAY2D_H
#define CORE23_LONGARRAY2D_H
...
namespace core {
    namespace native {
        ...
        /**
         * The LongArray2D class wrap the static two dimensionally array of values from native type
         ...
         */
        class LongArray2D CORE_FINAL : public PrimitiveArray2D<Long> {
        private:
            // glong
            CORE_ALIAS(Value, typename PrimitiveArray2D<Long>::Value);
            // glong[*][*]
            CORE_ALIAS(VALUE, typename Class<LongArray>::Pointer);
            /**
        ...
        public:
             ...
             * is similar to call LongArray2D(rows, 0)
             *
             * @param rows The number of rows
             */
            CORE_EXPLICIT LongArray2D(gint rows);
             ...
             */
            CORE_EXPLICIT LongArray2D(gint rows, const LongArray &initialValue);
             ...
             */
            CORE_EXPLICIT LongArray2D(gint rows, gint columns);
             ...
             */
            CORE_EXPLICIT LongArray2D(gint rows, gint columns, Value initialValue);
             ...
             */
            LongArray2D(const LongArray2D &matrix);
             ...
             * @param matrix The matrix used to initialize this matrix
             */
            LongArray2D(LongArray2D &&matrix) CORE_NOTHROW;
             ...
             * @param matrix The matrix used to initialize this matrix
             */
            LongArray2D &operator=(const LongArray2D &matrix);
             ...
             * @param matrix The matrix used to initialize this matrix
             */
            LongArray2D &operator=(LongArray2D &&matrix) CORE_NOTHROW;
             ...
             * @throws IndexException If specified index out of bounds
             */
            void set(gint index, const LongArray &newRow) override;
            ...
            /**
             * Tell if specified object is instance of PrimitiveArray2D<Long>
             ...
             */
            static LongArray2D of(LongArray v0);
             ...
             */
            static LongArray2D of(LongArray v0, LongArray v1);
             ...
             */
            static LongArray2D of(LongArray v0, LongArray v1, LongArray v2);
             ...
             */
            static LongArray2D of(LongArray v0, LongArray v1, LongArray v2, LongArray v3);
             ...
             */
            static LongArray2D
            of(LongArray v0, LongArray v1, LongArray v2, LongArray v3, LongArray v4);
             ...
             */
            static LongArray2D of(LongArray v0, LongArray v1, LongArray v2, LongArray v3,
                                   LongArray v4, LongArray v5, LongArray v6);
             ...
             */
            static LongArray2D of(LongArray v0, LongArray v1, LongArray v2, LongArray v3,
                                   LongArray v4, LongArray v5, LongArray v6, LongArray v7);
             ...
             */
            template<class ...LongArrays>
            static LongArray2D of(LongArray v0, LongArray v1, LongArray v2, LongArray v3,
                                   LongArray v4, LongArray v5, LongArray v6, LongArray v7,
                                   LongArray v8, LongArray v9, LongArrays &&...others) {
                CORE_STATIC_ASSERT(Class<LongArray2D>::template allIsTrue<Class<LongArray>::isSimilar<LongArrays>()...>(),
                                   "Could not create matrix with given arguments");
                try{
                    CORE_FAST gint n = sizeof...(LongArrays);
                    LongArray const tail[n] = {(LongArrays &&) others...};
                    LongArray2D matrix{10 + n};
                    for (int i = 0; i < n; i += 1) {
                        matrix[10 + i] = (LongArray &&) tail[i];
                    }
                    matrix[0] = (LongArray &&) v0;
                    matrix[1] = (LongArray &&) v1;
                    matrix[2] = (LongArray &&) v2;
                    matrix[3] = (LongArray &&) v3;
                    matrix[4] = (LongArray &&) v4;
                    matrix[5] = (LongArray &&) v5;
                    matrix[6] = (LongArray &&) v6;
                    matrix[7] = (LongArray &&) v7;
                    matrix[8] = (LongArray &&) v8;
                    matrix[9] = (LongArray &&) v9;
                    return (LongArray2D &&) matrix;
