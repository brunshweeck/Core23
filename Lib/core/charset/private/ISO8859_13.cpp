...
namespace core {
    namespace charset {
        ISO8859_13::ISO8859_13() : Charset("ISO-8859-13", StringArray::of("iso8859_13", "8859_13", "iso_8859-13", "ISO8859-13")) {
            SingleByte::initC2B(b2c, c2bNR, c2b, c2bIndex);
        }

        gbool ISO8859_13::contains(const Charset &cs) const {
            return cs.name().equals("US-ASCII") || Class<ISO8859_13>::hasInstance(cs);
        }

        CharsetDecoder &ISO8859_13::decoder() const {
            return Unsafe::allocateInstance<SingleByte::Decoder>(INSTANCE, b2c, true, false);
        }

        CharsetEncoder &ISO8859_13::encoder() const {
        ...
        CharArray ISO8859_13::b2c = CharArray::of(
        ...
        CharArray ISO8859_13::c2b = CharArray(0x300);
        CharArray ISO8859_13::c2bIndex = CharArray(0x100);
        CharArray ISO8859_13::c2bNR = CharArray(0);
