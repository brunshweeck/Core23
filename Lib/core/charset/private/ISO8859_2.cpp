...
namespace core {
    namespace charset {
        ISO8859_2::ISO8859_2() :
            Charset("ISO-8859-2", StringArray::of("iso8859_2", "8859_2", "iso-ir-101", "ISO_8859-2", "ISO_8859-2:1987", "ISO8859-2", "latin2", "l2", "ibm912", "ibm-912", "cp912", "912", "csISOLatin2")) {
            SingleByte::initC2B(b2c, c2bNR, c2b, c2bIndex);
        }

        gbool ISO8859_2::contains(const Charset &cs) const {
            return cs.name().equals("US-ASCII") || Class<ISO8859_2>::hasInstance(cs);
        }

        CharsetDecoder &ISO8859_2::decoder() const {
            return Unsafe::allocateInstance<SingleByte::Decoder>(INSTANCE, b2c, true, false);
        }

        CharsetEncoder &ISO8859_2::encoder() const {
        ...
        CharArray ISO8859_2::b2c = CharArray::of(
        ...
        CharArray ISO8859_2::c2b = CharArray(0x300);
        CharArray ISO8859_2::c2bIndex = CharArray(0x100);
        CharArray ISO8859_2::c2bNR = CharArray(0);
