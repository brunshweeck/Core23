...
namespace core {
    namespace charset {
        ...
        Windows932::Windows932() : Charset("windows-31j", StringArray::of("MS932", "windows-932", "csWindows31J")) {
            ...
            String const b2cNR = String(CharArray::of(
        ...
        gbool Windows932::contains(const Charset &cs) const {
            return (cs.name().equals("US-ASCII")) || (Class<JIS_X0201>::hasInstance(cs)) ||
                   (Class<Windows932>::hasInstance(cs));
        }

        CharsetDecoder &Windows932::decoder() const {
            return Unsafe::allocateInstance<DoubleByte::Decoder>(*this, b2c, b2cSB, 0x40, 0xFC, true);
        }

        CharsetEncoder &Windows932::encoder() const {
            return Unsafe::allocateInstance<DoubleByte::Encoder>(*this, c2b, c2bIndex, true);
        }

        Object &Windows932::clone() const {
            return INSTANCE;
        }

        String Windows932::b2cSBStr = String(CharArray::of(
        ...
        StringArray Windows932::b2cStr = StringArray::of(
                ""_S,
                ""_S,
                ""_S,
                ""_S,
                ...
                String(CharArray::of(
                        ...
                        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0x25EF
                )),
                String(CharArray::of(
                        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0xE0B7, 0xE0B8, 0xE0B9, 0xE0BA, 0xE0BB
                )),
                String(CharArray::of(
                        ...
                        0xE0F4, 0xE0F5, 0xE0F6, 0xE0F7, 0xE0F8, 0xE0F9, 0xE0FA, 0xFFFD,
                        ...
                        0xE173, 0xE174, 0xE175, 0xE176, 0xE177
                )),
                String(CharArray::of(
                        ...
                        0xE1B0, 0xE1B1, 0xE1B2, 0xE1B3, 0xE1B4, 0xE1B5, 0xE1B6, 0xFFFD,
                        ...
                        0xE22F, 0xE230, 0xE231, 0xE232, 0xE233
                )),
                String(CharArray::of(
                        ...
                        0xE26C, 0xE26D, 0xE26E, 0xE26F, 0xE270, 0xE271, 0xE272, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0xE328, 0xE329, 0xE32A, 0xE32B, 0xE32C, 0xE32D, 0xE32E, 0xFFFD,
                        ...
                        0xE3A7, 0xE3A8, 0xE3A9, 0xE3AA, 0xE3AB
                )),
                String(CharArray::of(
                        ...
                        0xE3E4, 0xE3E5, 0xE3E6, 0xE3E7, 0xE3E8, 0xE3E9, 0xE3EA, 0xFFFD,
                        ...
                        0xE463, 0xE464, 0xE465, 0xE466, 0xE467
                )),
                String(CharArray::of(
                        ...
                        0xE4A0, 0xE4A1, 0xE4A2, 0xE4A3, 0xE4A4, 0xE4A5, 0xE4A6, 0xFFFD,
                        ...
                        0xE51F, 0xE520, 0xE521, 0xE522, 0xE523
                )),
                String(CharArray::of(
                        ...
                        0xE55C, 0xE55D, 0xE55E, 0xE55F, 0xE560, 0xE561, 0xE562, 0xFFFD,
                        ...
                        0xE5DB, 0xE5DC, 0xE5DD, 0xE5DE, 0xE5DF
                )),
                String(CharArray::of(
                        ...
                        0xE618, 0xE619, 0xE61A, 0xE61B, 0xE61C, 0xE61D, 0xE61E, 0xFFFD,
                        ...
                        0xE697, 0xE698, 0xE699, 0xE69A, 0xE69B
                )),
                String(CharArray::of(
                        ...
                        0xE6D4, 0xE6D5, 0xE6D6, 0xE6D7, 0xE6D8, 0xE6D9, 0xE6DA, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0x9D6B, 0xFA2D, 0x9E19, 0x9ED1, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
                        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
                        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
                        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
                        0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
        ...
        CharArray2D Windows932::b2c = CharArray2D(b2cSBStr.length(), {});
        CharArray Windows932::b2cSB = {};
        CharArray Windows932::c2b = CharArray(0x6B00);
        CharArray Windows932::c2bIndex = CharArray(0x100);

        Windows932 Windows932::INSTANCE{};
