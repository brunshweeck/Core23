...
namespace core {
    namespace charset {
        IBM857::IBM857() :
            Charset("IBM857", StringArray::of("cp857", "ibm857", "ibm-857", "857", "csIBM857")) {
        ...
        CharArray IBM857::b2c = CharArray::of(
        ...
        CharArray IBM857::c2b = CharArray(0x400);
        CharArray IBM857::c2bIndex = CharArray(0x100);
        CharArray IBM857::c2bNR = CharArray(0);
