...
#include "Windows949.h"
#include <core/charset/private/DoubleByte.h>

namespace core {
    namespace charset {

        Windows949::Windows949() : Charset("x-windows-949",
                                           StringArray::of("ms949", "windows949", "windows-949", "ms_949")) {
        ...
        gbool Windows949::contains(const Charset &cs) const {
            return (cs.name().equals("US-ASCII")) || (Class<Windows949>::hasInstance(cs));
        }

        CharsetDecoder &Windows949::decoder() const {
            return Unsafe::allocateInstance<DoubleByte::Decoder>(*this, b2c, b2cSB, 0x41, 0xFE, true);
        }

        CharsetEncoder &Windows949::encoder() const {
            return Unsafe::allocateInstance<DoubleByte::Encoder>(*this, c2b, c2bIndex, true);
        }

        Object &Windows949::clone() const {
            return INSTANCE;
        }

        String Windows949::b2cSBStr = String(CharArray::of(
        ...
        StringArray Windows949::b2cStr = StringArray::of(
                ""_S,
                ""_S,
                ""_S,
                ""_S,
        ...
        CharArray2D Windows949::b2c = CharArray2D(b2cSBStr.length(), {});
        CharArray Windows949::b2cSB = {};
        CharArray Windows949::c2b = CharArray(0x9300);
        CharArray Windows949::c2bIndex = CharArray(0x100);

        Windows949 Windows949::INSTANCE{};
