...
namespace core {
    namespace charset {
        IBM855::IBM855() :
            Charset("IBM855", StringArray::of( "cp855", "ibm-855", "ibm855", "855", "cspcp855")) {
        ...
        CharArray IBM855::b2c = CharArray::of(
        ...
        CharArray IBM855::c2b = CharArray(0x400);
        CharArray IBM855::c2bIndex = CharArray(0x100);
        CharArray IBM855::c2bNR = CharArray(0);
