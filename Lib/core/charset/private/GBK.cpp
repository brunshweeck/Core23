...
namespace core {
    namespace charset {
        ...
        GBK::GBK() : Charset("GBK", StringArray::of("windows-936", "CP936")) {
        ...
        gbool GBK::contains(const Charset &cs) const {
            return (cs.name().equals("US-ASCII")) || (Class<GBK>::hasInstance(cs));
        }

        CharsetDecoder &GBK::decoder() const {
            return Unsafe::allocateInstance<DoubleByte::Decoder>(*this, b2c, b2cSB, 0x40, 0xFE, true);
        }

        CharsetEncoder &GBK::encoder() const {
            return Unsafe::allocateInstance<DoubleByte::Encoder>(*this, c2b, c2bIndex, true);
        }

        Object &GBK::clone() const {
            return INSTANCE;
        }

        String GBK::b2cSBStr = String(CharArray::of(
        ...
        StringArray GBK::b2cStr = StringArray::of(
                ""_S,
                ""_S,
                ""_S,
                ""_S,
        ...
        CharArray2D GBK::b2c = CharArray2D(b2cSBStr.length(), {});
        CharArray GBK::b2cSB = {};
        CharArray GBK::c2b = CharArray(0x7000);
        CharArray GBK::c2bIndex = CharArray(0x100);
