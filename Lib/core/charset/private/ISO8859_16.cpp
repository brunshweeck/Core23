...
namespace core {
    namespace charset {
        ISO8859_16::ISO8859_16() :
            Charset("ISO-8859-16", StringArray::of("iso-ir-226", "ISO_8859-16:2001", "ISO_8859-16", "ISO8859_16", "latin10", "l10", "csISO885916")) {
            SingleByte::initC2B(b2c, c2bNR, c2b, c2bIndex);
        }

        gbool ISO8859_16::contains(const Charset &cs) const {
            return cs.name().equals("US-ASCII") || Class<ISO8859_16>::hasInstance(cs);
        }

        CharsetDecoder &ISO8859_16::decoder() const {
            return Unsafe::allocateInstance<SingleByte::Decoder>(INSTANCE, b2c, true, false);
        }

        CharsetEncoder &ISO8859_16::encoder() const {
        ...
        CharArray ISO8859_16::b2c = CharArray::of(
                ...
                0x00A0, 0x0104, 0x0105, 0x0141, 0x20AC, 0x201E, 0x0160, 0x00A7,      // 0xa0 - 0xa7
                0x0161, 0x00A9, 0x0218, 0x00AB, 0x0179, 0x00AD, 0x017A, 0x017B,      // 0xa8 - 0xaf
                0x00B0, 0x00B1, 0x010C, 0x0142, 0x017D, 0x201D, 0x00B6, 0x00B7,      // 0xb0 - 0xb7
                0x017E, 0x010D, 0x0219, 0x00BB, 0x0152, 0x0153, 0x0178, 0x017C,      // 0xb8 - 0xbf
                0x00C0, 0x00C1, 0x00C2, 0x0102, 0x00C4, 0x0106, 0x00C6, 0x00C7,      // 0xc0 - 0xc7
                0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC, 0x00CD, 0x00CE, 0x00CF,      // 0xc8 - 0xcf
                0x0110, 0x0143, 0x00D2, 0x00D3, 0x00D4, 0x0150, 0x00D6, 0x015A,      // 0xd0 - 0xd7
                0x0170, 0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x0118, 0x021A, 0x00DF,      // 0xd8 - 0xdf
                0x00E0, 0x00E1, 0x00E2, 0x0103, 0x00E4, 0x0107, 0x00E6, 0x00E7,      // 0xe0 - 0xe7
                0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00EC, 0x00ED, 0x00EE, 0x00EF,      // 0xe8 - 0xef
                0x0111, 0x0144, 0x00F2, 0x00F3, 0x00F4, 0x0151, 0x00F6, 0x015B,      // 0xf0 - 0xf7
                0x0171, 0x00F9, 0x00FA, 0x00FB, 0x00FC, 0x0119, 0x021B, 0x00FF,      // 0xf8 - 0xff
        ...
        CharArray ISO8859_16::c2b = CharArray(0x400);
        CharArray ISO8859_16::c2bIndex = CharArray(0x100);
        CharArray ISO8859_16::c2bNR = CharArray(0);
