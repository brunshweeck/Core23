...
namespace core {
    namespace charset {
        IBM874::IBM874() :
            Charset("x-IBM874", StringArray::of("cp874", "ibm874", "ibm-874", "874")) {
        ...
        gbool IBM874::contains(const Charset &cs) const {
            return cs.name().equals("US-ASCII") || Class<IBM874>::hasInstance(cs);
        }

        CharsetDecoder &IBM874::decoder() const {
            return Unsafe::allocateInstance<SingleByte::Decoder>(INSTANCE, b2c, false, false);
        }

        CharsetEncoder &IBM874::encoder() const {
        ...
        CharArray IBM874::b2c = CharArray::of(
                0x20AC, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,      // 0x80 - 0x87
                ...
                0x0E48, 0x0E01, 0x0E02, 0x0E03, 0x0E04, 0x0E05, 0x0E06, 0x0E07,      // 0xa0 - 0xa7
                ...
                0x0E38, 0x0E39, 0x0E3A, 0x0E49, 0x0E4A, 0x0E4B, 0x0E4C, 0x0E3F,      // 0xd8 - 0xdf
                ...
                0x0E58, 0x0E59, 0x0E5A, 0x0E5B, 0x00A2, 0x00AC, 0x00A6, 0x00A0,      // 0xf8 - 0xff
        ...
        CharArray IBM874::c2b = CharArray(0x400);
        CharArray IBM874::c2bIndex = CharArray(0x100);
        CharArray IBM874::c2bNR = CharArray(0);
