...
#include "Windows936.h"
#include <core/charset/private/DoubleByte.h>

namespace core {
    namespace charset {

        Windows936::Windows936() : Charset("x-mswin-936", StringArray::of("ms936", "ms_936")) {
        ...
        gbool Windows936::contains(const Charset &cs) const {
            return (cs.name().equals("US-ASCII")) || (Class<Windows936>::hasInstance(cs));
        }

        CharsetDecoder &Windows936::decoder() const {
            return Unsafe::allocateInstance<DoubleByte::Decoder>(*this, b2c, b2cSB, 0x40, 0xFE, true);
        }

        CharsetEncoder &Windows936::encoder() const {
            return Unsafe::allocateInstance<DoubleByte::Encoder>(*this, c2b, c2bIndex, true);
        }

        Object &Windows936::clone() const {
            return INSTANCE;
        }

        String Windows936::b2cSBStr = String(CharArray::of(
                ...
                0x20AC, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD, 0xFFFD,
        ...
        StringArray Windows936::b2cStr = StringArray::of(
                ""_S,
                ""_S,
                ""_S,
                ""_S,
                ...
                String(CharArray::of(
                        ...
                        0xE4FE, 0xE4FF, 0xE500, 0xE501, 0xE502, 0xE503, 0xE504, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0xE55E, 0xE55F, 0xE560, 0xE561, 0xE562, 0xE563, 0xE564, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0xE5BE, 0xE5BF, 0xE5C0, 0xE5C1, 0xE5C2, 0xE5C3, 0xE5C4, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0xE61E, 0xE61F, 0xE620, 0xE621, 0xE622, 0xE623, 0xE624, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0xE67E, 0xE67F, 0xE680, 0xE681, 0xE682, 0xE683, 0xE684, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0xE6DE, 0xE6DF, 0xE6E0, 0xE6E1, 0xE6E2, 0xE6E3, 0xE6E4, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0xE73E, 0xE73F, 0xE740, 0xE741, 0xE742, 0xE743, 0xE744, 0xFFFD,
                ...
                String(CharArray::of(
                        ...
                        0xE057, 0xE058, 0xE059, 0xE05A, 0xE05B, 0xE05C, 0xE05D
                )),
                String(CharArray::of(
                ...
                String(CharArray::of(
                        ...
                        0xE171, 0xE172, 0xE173, 0xE174, 0xE175, 0xE176, 0xE177
                )),
                String(CharArray::of(
                        ...
                        0xE1CF, 0xE1D0, 0xE1D1, 0xE1D2, 0xE1D3, 0xE1D4, 0xE1D5
                )),
                String(CharArray::of(
                ...
                String(CharArray::of(
                        ...
                        0xE2E9, 0xE2EA, 0xE2EB, 0xE2EC, 0xE2ED, 0xE2EE, 0xE2EF
                )),
                String(CharArray::of(
                        ...
                        0xE347, 0xE348, 0xE349, 0xE34A, 0xE34B, 0xE34C, 0xE34D
                )),
                String(CharArray::of(
                        ...
                        0xE3A5, 0xE3A6, 0xE3A7, 0xE3A8, 0xE3A9, 0xE3AA, 0xE3AB
                )),
                String(CharArray::of(
                        ...
                        0xE403, 0xE404, 0xE405, 0xE406, 0xE407, 0xE408, 0xE409
                )),
                String(CharArray::of(
                        ...
                        0xE461, 0xE462, 0xE463, 0xE464, 0xE465, 0xE466, 0xE467
                )),
                String(CharArray::of(
                        ...
                        0xE83D, 0xE83E, 0xE83F, 0xE840, 0xE841, 0xE842, 0xE843, 0xFFFD,
        ...
        CharArray2D Windows936::b2c = CharArray2D(b2cSBStr.length(), {});
        CharArray Windows936::b2cSB = {};
        CharArray Windows936::c2b = CharArray(0x7000);
        CharArray Windows936::c2bIndex = CharArray(0x100);

        Windows936 Windows936::INSTANCE{};
