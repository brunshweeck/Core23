...
namespace core {
    namespace charset {
        KOI8_U::KOI8_U() : Charset("KOI8-U", StringArray::of("koi8_u")) {
            SingleByte::initC2B(b2c, c2bNR, c2b, c2bIndex);
        }

        gbool KOI8_U::contains(const Charset &cs) const {
            return cs.name().equals("US-ASCII") || Class<KOI8_U>::hasInstance(cs);
        }

        CharsetDecoder &KOI8_U::decoder() const {
            return Unsafe::allocateInstance<SingleByte::Decoder>(INSTANCE, b2c, true, false);
        }

        CharsetEncoder &KOI8_U::encoder() const {
            return Unsafe::allocateInstance<SingleByte::Encoder>(INSTANCE, c2b, c2bIndex, true);
        }

        Object &KOI8_U::clone() const {
            return INSTANCE;
        }

        CharArray KOI8_U::b2c = CharArray::of(
                ...
                0x2550, 0x2551, 0x2552, 0x0451, 0x0454, 0x2554, 0x0456, 0x0457,      // 0xa0 - 0xa7
                0x2557, 0x2558, 0x2559, 0x255A, 0x255B, 0x0491, 0x255D, 0x255E,      // 0xa8 - 0xaf
                0x255F, 0x2560, 0x2561, 0x0401, 0x0404, 0x2563, 0x0406, 0x0407,      // 0xb0 - 0xb7
                0x2566, 0x2567, 0x2568, 0x2569, 0x256A, 0x0490, 0x256C, 0x00A9,      // 0xb8 - 0xbf
        ...
        CharArray KOI8_U::c2b = CharArray(0x500);
        CharArray KOI8_U::c2bIndex = CharArray(0x100);
        CharArray KOI8_U::c2bNR = CharArray(0);

        // initialize after b2c, c2b, ... for calling SingleByte.initC2B
        KOI8_U KOI8_U::INSTANCE{};
    } // charset
} // core