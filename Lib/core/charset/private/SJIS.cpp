...
namespace core {
    namespace charset {
        ...
        SJIS::SJIS() : Charset("ShiftJIS",
                               StringArray::of("sjis", "shift_jis", "shift-jis", "ms_kanji", "x-sjis", "csShiftJIS")) {
        ...
        gbool SJIS::contains(const Charset &cs) const {
            return (cs.name().equals("US-ASCII")) || (Class<SJIS>::hasInstance(cs));
        }

        CharsetDecoder &SJIS::decoder() const {
            return Unsafe::allocateInstance<DoubleByte::Decoder>(*this, b2c, b2cSB, 0x40, 0xFC, true);
        }

        CharsetEncoder &SJIS::encoder() const {
            return Unsafe::allocateInstance<DoubleByte::Encoder>(*this, c2b, c2bIndex, true);
        }

        Object &SJIS::clone() const {
            return INSTANCE;
        }

        String SJIS::b2cSBStr = String(CharArray::of(
        ...
        StringArray SJIS::b2cStr = StringArray::of(
                ""_S,
                ""_S,
                ""_S,
                ""_S,
        ...
        CharArray2D SJIS::b2c = CharArray2D(b2cSBStr.length(), {});
        CharArray SJIS::b2cSB = {};
        CharArray SJIS::c2b = CharArray(0x5E00);
        CharArray SJIS::c2bIndex = CharArray(0x100);
