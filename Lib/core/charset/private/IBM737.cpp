...
namespace core {
    namespace charset {
        IBM737::IBM737() :
            Charset("x-IBM737", StringArray::of("cp737", "ibm737", "ibm-737", "737")) {
        ...
        CharArray IBM737::b2c = CharArray::of(
                0x0391, 0x0392, 0x0393, 0x0394, 0x0395, 0x0396, 0x0397, 0x0398,      // 0x80 - 0x87
                0x0399, 0x039A, 0x039B, 0x039C, 0x039D, 0x039E, 0x039F, 0x03A0,      // 0x88 - 0x8f
                0x03A1, 0x03A3, 0x03A4, 0x03A5, 0x03A6, 0x03A7, 0x03A8, 0x03A9,      // 0x90 - 0x97
                0x03B1, 0x03B2, 0x03B3, 0x03B4, 0x03B5, 0x03B6, 0x03B7, 0x03B8,      // 0x98 - 0x9f
                0x03B9, 0x03BA, 0x03BB, 0x03BC, 0x03BD, 0x03BE, 0x03BF, 0x03C0,      // 0xa0 - 0xa7
                0x03C1, 0x03C3, 0x03C2, 0x03C4, 0x03C5, 0x03C6, 0x03C7, 0x03C8,      // 0xa8 - 0xaf
                ...
                0x03C9, 0x03AC, 0x03AD, 0x03AE, 0x03CA, 0x03AF, 0x03CC, 0x03CD,      // 0xe0 - 0xe7
                0x03CB, 0x03CE, 0x0386, 0x0388, 0x0389, 0x038A, 0x038C, 0x038E,      // 0xe8 - 0xef
                0x038F, 0x00B1, 0x2265, 0x2264, 0x03AA, 0x03AB, 0x00F7, 0x2248,      // 0xf0 - 0xf7
        ...
        CharArray IBM737::c2b = CharArray(0x500);
        CharArray IBM737::c2bIndex = CharArray(0x100);
        CharArray IBM737::c2bNR = CharArray(0);
