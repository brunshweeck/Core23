...
namespace core {
    namespace charset {
        IBM850::IBM850() :
            Charset("IBM850", StringArray::of("cp850", "ibm-850", "ibm850", "850", "cspc850multilingual")) {
        ...
        CharArray IBM850::b2c = CharArray::of(
        ...
        CharArray IBM850::c2b = CharArray(0x400);
        CharArray IBM850::c2bIndex = CharArray(0x100);
        CharArray IBM850::c2bNR = CharArray(0);
