...
namespace core {
    namespace charset {
        IBM437::IBM437() :
            Charset("IBM437", StringArray::of("cp437", "ibm437", "ibm-437", "437", "cspc8codepage437", "windows-437")) {
        ...
        CharArray IBM437::b2c = CharArray::of(
        ...
        CharArray IBM437::c2b = CharArray(0x700);
        CharArray IBM437::c2bIndex = CharArray(0x100);
        CharArray IBM437::c2bNR = CharArray(0);
