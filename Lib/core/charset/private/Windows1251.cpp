...
namespace core {
    namespace charset {
        Windows1251::Windows1251() : Charset("windows-1251", StringArray::of("cp1251", "cp5346")) {
            SingleByte::initC2B(b2c, c2bNR, c2b, c2bIndex);
        }

        gbool Windows1251::contains(const Charset &cs) const {
            return cs.name().equals("US-ASCII") || Class<Windows1251>::hasInstance(cs);
        }

        CharsetDecoder &Windows1251::decoder() const {
            return Unsafe::allocateInstance<SingleByte::Decoder>(INSTANCE, b2c, true, false);
        }

        CharsetEncoder &Windows1251::encoder() const {
            return Unsafe::allocateInstance<SingleByte::Encoder>(INSTANCE, c2b, c2bIndex, true);
        }

        Object &Windows1251::clone() const {
            return INSTANCE;
        }

        CharArray Windows1251::b2c = CharArray::of(
                ...
                0xFFFD, 0x2122, 0x0459, 0x203A, 0x045A, 0x045C, 0x045B, 0x045F,      // 0x98 - 0x9f
        ...
        CharArray Windows1251::c2b = CharArray(0x500);
        CharArray Windows1251::c2bIndex = CharArray(0x100);
        CharArray Windows1251::c2bNR = CharArray(0);

        // initialize after b2c, c2b, ... for calling SingleByte.initC2B
        Windows1251 Windows1251::INSTANCE{};
    } // charset
} // core