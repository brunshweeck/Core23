...
namespace core {
    namespace charset {
        IBM858::IBM858() :
            Charset("IBM00858", StringArray::of("cp858", "ccsid00858", "cp00858", "858", "PC-Multilingual-850+euro", "ibm858", "ibm-858")) {
        ...
        CharArray IBM858::b2c = CharArray::of(
        ...
        CharArray IBM858::c2b = CharArray(0x400);
        CharArray IBM858::c2bIndex = CharArray(0x100);
        CharArray IBM858::c2bNR = CharArray(0);
