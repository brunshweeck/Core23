...
namespace core {
    namespace charset {
        IBM866::IBM866() : Charset("IBM866", StringArray::of("cp866", "ibm866", "ibm-866", "866", "csIBM866")) {
        ...
        CharArray IBM866::b2c = CharArray::of(
        ...
        CharArray IBM866::c2b = CharArray(0x500);
        CharArray IBM866::c2bIndex = CharArray(0x100);
        CharArray IBM866::c2bNR = CharArray(0);
