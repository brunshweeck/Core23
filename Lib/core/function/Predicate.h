    ...
    namespace function {
        ...
        public:
            ...
            CORE_IMPLICIT Predicate(Callable &&c) CORE_NOTHROW : tester(0) {
                ...
                tester = &Launcher::of(Unsafe::forwardInstance<Callable>(c));
            }
            ...
            Predicate(const Predicate<T> &c) : tester(0) {
                tester = &Unsafe::copyInstance(*c.tester);
            }
            ...
            Predicate<T> &operator=(const Predicate<T> &c) {
                if (this != &c) {
                    Tester tester0 = &Unsafe::copyInstance(*c.tester);
                    Unsafe::destroyInstance(*tester);
                    tester = tester0;
                }
                return *this;
            }
            ...
            Object &clone() const override {
                return Unsafe::allocateInstance<Predicate<T>>(*this);
            }
