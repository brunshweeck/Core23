...
#ifndef CORE23_LONGSUPPLIER_H
#define CORE23_LONGSUPPLIER_H
...
namespace core {
    namespace function {
        ...
        /**
         * Represents a supplier of <b> long</b> -valued results.  This is the
         * <b> long</b> -producing primitive specialization of <b style="color: orange;"> Supplier</b> .
         *
         ...
         * @see Supplier
         */
        class LongSupplier : public Functional {
        public:
            ...
            static LongSupplier &from(I &&instance, M &&method) {
                ...
                // The return type must be convertible to long value
                Functional::CheckReturn<glong, R>();

                class MethodSupplier : public LongSupplier {
                private:
                    I &&inst;
                    M &&meth;
            ...
            static LongSupplier &from(F &&function) {
                ...
                class FunctionSupplier CORE_FINAL : public LongSupplier {
                private:
                    F &&func;
