...
#ifndef CORE23_DOUBLEFUNCTION_H
#define CORE23_DOUBLEFUNCTION_H
...
namespace core {
    namespace function {
        ...
        template<class R>
        class DoubleFunction : public Functional {
        private:
        ...
        public:
             ...
             */
            virtual Z apply(gdouble t) const = 0;
            ...
            static DoubleFunction &from(I &&instance, M &&method) {
                ...
                try {
                    ...
                    ex.throws(__trace(u"core.function.DoubleFunction"_S));
                }
                ...
                class MethodFunction : public DoubleFunction {
                private:
                    I &&inst;
                    M &&meth;
                ...
                public:
                    ...
                    Z apply(gdouble t) const override {
                        return (Z) invoke(t);
                    }
             ...
             */
            template<class F>
            static DoubleFunction &from(F &&function) {
                ...
                class FunctionFunction CORE_FINAL : public DoubleFunction {
                        private:
                        F &&func;
