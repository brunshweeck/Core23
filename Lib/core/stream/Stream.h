...
#ifndef CORE23_STREAM_H
#define CORE23_STREAM_H
...
namespace core {
    namespace stream {
        ...
        public:
            CORE_STATIC_ASSERT(Class<Object>::template isSuper<T>(),
                               "The type Stream elements must have core.Object as base class");
             ...
             */
             Stream<T> &filter(const Predicate<T> &predicate) const = 0;
             ...
             * @return the new stream
             */
             virtual Stream<Object> &map(const Function<T, Object&> &mapper) const = 0;
             ...
             * @return the new stream
             */
            virtual IntStream mapToInt(const ToIntFunction<T> &mapper) const = 0;
             ...
             * @return the new stream
             */
            virtual LongStream mapToLong(const ToLongFunction<T> &mapper) const = 0;
             ...
             * @return the new stream
             */
            virtual DoubleStream mapToDouble(const ToDoubleFunction<T> &mapper) const = 0;
             ...
             * @see #mapMulti
             */
            virtual Stream<T> &flatMap(const Function<T, Stream<T>> &mapper) const = 0;
            virtual Stream<Object> &flatMapToObj(const Function<T, Stream<Object>> &mapper) const = 0;
             ...
             */
            virtual IntStream &flatMapToInt(const Function<T, IntStream> &mapper) = 0;
             ...
             * @see #flatMap(Function)
             */
            virtual LongStream flatMapToLong(const Function<T, LongStream> &mapper) const = 0;
             ...
             * @see #flatMap(Function)
             */
            virtual DoubleStream flatMapToDouble(const Function<T, DoubleStream> &mapper) const = 0;
             ...
             *
             * @implSpec
             * The virtual implementation invokes {@link #flatMap flatMap} on this stream,
             ...
             * @since 16
             */
            virtual Stream<T> &mapMulti(const BiConsumer<T, Consumer<T>> &mapper) = 0;
             ...
             *
             * @implSpec
             * The virtual implementation invokes {@link #flatMapToInt flatMapToInt} on this stream,
             * passing a function that behaves as follows. First, it calls the mapper function
             ...
             * @since 16
             */
            virtual IntStream &mapMultiToInt(const BiConsumer<T, IntConsumer> &mapper) const = 0;
             ...
             *
             * @implSpec
             * The virtual implementation invokes {@link #flatMapToLong flatMapToLong} on this stream,
             * passing a function that behaves as follows. First, it calls the mapper function
             ...
             * @since 16
             */
            virtual LongStream mapMultiToLong(const BiConsumer<T, LongConsumer> &mapper) const = 0;
             ...
             *
             * @implSpec
             * The virtual implementation invokes {@link #flatMapToDouble flatMapToDouble} on this stream,
             * passing a function that behaves as follows. First, it calls the mapper function
             ...
             * @since 16
             */
            virtual DoubleStream &mapMultiToDouble(const BiConsumer<T, DoubleConsumer> &mapper) const = 0;
             ...
             * @return the new stream
             */
            virtual Stream<T> &distinct() const = 0;
             ...
             * @return the new stream
             */
            virtual Stream<T> sorted() const = 0;
             ...
             * @return the new stream
             */
            virtual Stream<T> &sorted(const Comparator<T> &comparator) const = 0;
             ...
             * @return the new stream
             */
            virtual Stream<T> &peek(const Consumer<T> &action) const = 0;
             ...
             */
            virtual Stream<T> &limit(glong maxSize) = 0;
             ...
             */
            virtual Stream<T> &skip(glong n) = 0;
             ...
             *
             * @implSpec
             * The virtual implementation obtains the {@link #spliterator() spliterator}
             ...
             * @since 9
             */
            virtual Stream<T> &takeWhile(Predicate<T> predicate) = 0;
             ...
             * @since 9
             */
            virtual Stream<T> &dropWhile(Predicate<T> predicate) = 0;
             ...
             */
            void forEach(const Consumer<T> &action) = 0;
             ...
             */
            virtual void forEachOrdered(const Consumer<T> &action) = 0;
             ...
             */
            virtual ObjectArray toArray(IntFunction<ObjectArray> generator) = 0;
             ...
             */
            virtual T reduce(T identity, BinaryOperator<T> accumulator) = 0;
             ...
             * @see #max(Comparator)
             */
            Optional<T> reduce(const BinaryOperator<T> &accumulator) = 0;
             ...
             * @return the result of the reduction
             */
            virtual T collect(Supplier<T> supplier, BiConsumer<T, T> accumulator, BiConsumer<T, T> combiner) = 0;
             ...
             */
            virtual Optional<T> min(Comparator<T> comparator) = 0;
             ...
             */
            virtual Optional<T> max(Comparator<T> comparator) = 0;
             ...
             *     glong count = l.stream().peek(System.out::println).count();
             * }</pre>
             ...
             */
            virtual gbool anyMatch(const Predicate<T> &predicate) = 0;
             ...
             */
            virtual gbool allMatch(Predicate<T> predicate) = 0;
             ...
             * provided predicate or the stream is empty, otherwise {@code false}
             */
            virtual gbool noneMatch(Predicate<T> predicate) = 0;
             ...
             */
            virtual Optional<T> findFirst() = 0;
             ...
             * @see #findFirst()
             */
            virtual Optional<T> findAny() = 0;
        };

    } // stream
} // core

#endif //CORE23_STREAM_H
