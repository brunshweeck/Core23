...
namespace core {
    namespace io {
        ...
        public:
             ...
             *         The new buffer's position will be setValue to this value.
             *
             * @param  end
             *         The index of the character following the last character to be
             *         used; must be no smaller than <b> start</b>  and no larger
             *         than <b> csq.length()</b> .
             *         The new buffer's limit will be setValue to this value.
             *
        ...
        public:
             ...
             *
             * <p> The buffer's position is setValue to the number of chars copied,
