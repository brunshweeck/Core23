...
#ifndef CORE23_DOUBLEBUFFER_H
#define CORE23_DOUBLEBUFFER_H
...
namespace core {
    namespace io {
         ...
         *   gdouble array or some other gdouble
         *   buffer into this buffer;</p></li>
         *
         *
         *   <li><p> A method for <b style="color:orange;"> compacting</b>
         *   a gdouble buffer.  </p></li>
         *
         * </ul>
         *
         * <p> Double buffers can be created either by <b style="color:orange;">
         * <i>allocation</i></b> , which allocates space for the buffer's
         *
         * content, by <b style="color:orange;"> <i>wrapping</i></b>  an existing
         * gdouble array  into a buffer, or by creating a
         * <a href=""><i>view</i></a> of an existing byte buffer.
         *
         * <p> Like a byte buffer, a gdouble buffer is either <a
         * href=""><i>direct</i> or <i>non-direct</i></a>.  A
         * gdouble buffer created via the <b> wrap</b>  methods of this class will
         * be non-direct.  A gdouble buffer created as a view of a byte buffer will
         * be direct if, and only if, the byte buffer itself is direct.  Whether or not
         * a gdouble buffer is direct may be determined by invoking the <b style="color:orange;">
         * isDirect</b>  method.  </p>
         *
        ...
        class DoubleBuffer : public Buffer, public Comparable<DoubleBuffer> {
        private:
            static const glong ARRAY_BASE_OFFSET;

        protected:
            CORE_ALIAS(HeapDoubles, typename Class<DoubleArray>::Ptr);
            ...
            //
            CORE_EXPLICIT DoubleBuffer(gint mark, gint pos, gint lim, gint cap, DoubleArray & hb, gint offset);

            // Creates a new buffer with the given mark, position, limit, and capacity
            //
            CORE_EXPLICIT DoubleBuffer(gint mark, gint pos, gint lim, gint cap);

            // Creates a new buffer with given base, address and capacity
            //
            CORE_EXPLICIT DoubleBuffer(DoubleArray & hb, glong addr, gint cap);
        ...
        public:
            ...
            /**
             * Allocates a new gdouble buffer.
             *
            ...
            /**
             * Wraps a gdouble array into a buffer.
             *
             * <p> The new buffer will be backed by the given gdouble array;
            ...
            /**
             * Creates a new gdouble buffer whose content is a shared subsequence of
            ...
            /**
             * Creates a new gdouble buffer that shares this buffer's content.
             *
            ...
            /**
             * Creates a new, read-only gdouble buffer that shares this buffer's
             * content.
             *
             * <p> The content of the new buffer will be that of this buffer.  Changes
             ...
             *
             * @return  The new, read-only gdouble buffer
             */
            virtual DoubleBuffer &asReadOnlyBuffer() const = 0;

            /**
             * Relative <i>get</i> method.  Reads the gdouble at this buffer's
             * current position, and then increments the position.
             *
             * @return  The gdouble at the buffer's current position
             *
             ...
             *
             * <p> Writes the given gdouble into this buffer at the current
             * position, and then increments the position. </p>
             *
             * @param  f
             *         The gdouble to be written
             *
             * @return  This buffer
             *
             ...
             */
            virtual DoubleBuffer &put(gdouble f) = 0;

            /**
             * Absolute <i>get</i> method.  Reads the gdouble at the given
             * index.
             *
             * @param  index
             *         The index from which the gdouble will be read
             *
             * @return  The gdouble at the given index
             *
             * @throws  IndexException
             ...
             *
             * <p> Writes the given gdouble into this buffer at the given
             * index. </p>
             *
             * @param  index
             *         The index at which the gdouble will be written
             *
             * @param  f
             *         The gdouble value to be written
             *
             * @return  This buffer
             *
             * @throws  IndexException
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer &put(gint index, gdouble f) = 0;
             ...
             * doubles are transferred and a <b style="color:orange;"> BufferUnderflowException</b>  is
             * thrown.
             *
             * <p> Otherwise, this method copies <b> length</b>  doubles from this
             ...
             *
             * @param  offset
             *         The offset within the array of the first gdouble to be
             ...
             *
             * @throws  BufferUnderflowException
             *          If there are fewer than <b> length</b>  doubles
             ...
             *
             * <p> This method transfers <b> length</b>  doubles from this
             ...
             *
             * @param  index
             *         The index in this buffer from which the first gdouble will be
             ...
             */
            virtual DoubleBuffer &get(gint index, DoubleArray &dst, gint offset, gint length) const;
             ...
             */
            virtual DoubleBuffer &get(gint index, DoubleArray &dst) const;

        private:
            DoubleBuffer &getArray(gint index, DoubleArray &dst, gint offset, gint length) const;
        ...
        public:
             ...
             * then no doubles are transferred and a <b style="color:orange;">
             * BufferOverflowException</b>  is thrown.
             *
             * <p> Otherwise, this method copies
             * <i>n</i>&nbsp;=&nbsp;<b> src.remaining()</b>  doubles from the given
             ...
             *
             * <p> This method transfers <b> length</b>  doubles into this buffer from
             ...
             *
             * @param index
             *        The index in this buffer at which the first gdouble will be
             ...
             *
             * @param offset
             *        The index within the source buffer of the first gdouble to be
        ...
        private:
            void putBuffer(gint pos, DoubleBuffer &src, gint srcPos, gint n);
        ...
        public:
             ...
             * <b> length</b> &nbsp;<b> ></b> &nbsp;<b> remaining()</b> , then no
             * doubles are transferred and a <b style="color:orange;"> BufferOverflowException</b>  is
             * thrown.
             *
             * <p> Otherwise, this method copies <b> length</b>  doubles from the
             ...
             *
             * @param  offset
             *         The offset within the array of the first gdouble to be read;
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer &put(const DoubleArray &src, gint offset, gint length);

            /**
             * Relative bulk <i>put</i> method&nbsp;&nbsp;<i>(optional operation)</i>.
             *
             * <p> This method transfers the entire content of the given source
             * gdouble array into this buffer.  An invocation of this method of the
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer &put(const DoubleArray &src);

            /**
             * Absolute bulk <i>put</i> method&nbsp;&nbsp;<i>(optional operation)</i>.
             *
             * <p> This method transfers <b> length</b>  doubles from the given
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer &put(gint index, const DoubleArray &src, gint offset, gint length);
             ...
             *          If this buffer is read-only
             */
            virtual DoubleBuffer &put(gint index, const DoubleArray &src);

        private:
            DoubleBuffer &putArray(gint index, const DoubleArray &src, gint offset, gint length);

        public:
            // -- Other stuff --

            /**
             * Tells whether or not this buffer is backed by an accessible gdouble
             * array.
             *
            ...
            /**
             * Returns the gdouble array that backs this
             ...
             * {@inheritDoc</b>
             */
            DoubleBuffer &setPosition(gint newPosition) override;

            /**
             * {@inheritDoc</b>
             */
            DoubleBuffer &setLimit(gint newLimit) override;
             ...
             * gdouble at index <i>p</i>&nbsp;=&nbsp;<b> position()</b>  is copied
             * to index zero, the gdouble at index <i>p</i>&nbsp;+&nbsp;1 is copied
             * to index one, and so forth until the gdouble at index
             ...
             *
             * <p> The buffer's position is setValue to the number of doubles copied,
            ...
            /**
             * Tells whether or not this gdouble buffer is direct.
             *
             ...
             *
             * <p> The hash code of a gdouble buffer depends only upon its remaining
             ...
             *
             * <p> Two gdouble buffers are equal if, and only if,
             *
             * <ol>
             *
             ...
             *   This method considers two gdouble elements <b> a</b>  and <b> b</b>
             *   to be equal if
             *   <b> (a == b) || (Double.isNaN(a) && Double.isNaN(b))</b> .
             *   The values <b> -0.0</b>  and <b> +0.0</b>  are considered to be
             *   equal, unlike <b style="color:orange;"> Double.equals(Object)</b> .

             *   </p></li>
             *
             * </ol>
             *
             * <p> A gdouble buffer is not equal to any other type of object.  </p>
             *
        ...
        private:
            ...
            static int mismatch(const DoubleBuffer &a, int aOff, const DoubleBuffer &b, int bOff, int length);
        ...
        public:
             ...
             *
             * <p> Two gdouble buffers are compared by comparing their sequences of
             * remaining elements lexicographically, without regard to the starting
             * position of each sequence within its corresponding buffer.

             * Pairs of <b> gdouble</b>  elements are compared as if by invoking
             * <b style="color:orange;"> Double.compare(gdouble,gdouble)</b> , except that
             * <b> -0.0</b>  and <b> 0.0</b>  are considered to be equal.
             * <b> Double.NaN</b>  is considered by this method to be equal
             * to itself and greater than all other <b> gdouble</b>  values
             * (including <b> Double.POSITIVE_INFINITY</b> ).
             *
             * <p> A gdouble buffer is not comparable to any other type of object.
             *
             ...
             */
            gint mismatch(const DoubleBuffer &that) const;

            /**
             * Retrieves this buffer's byte order.
             *
             * <p> The byte order of a gdouble buffer created by allocation or by
             * wrapping an existing <b> gdouble</b>  array is the <b style="color:orange;">
             * native order</b>  of the underlying
             * hardware.  The byte order of a gdouble buffer created as a <a
